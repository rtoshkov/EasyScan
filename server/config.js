...
module.exports = {
    ...
    SHEETS: {
        ...
        TEST_TELUS_INVENTORY: process.env.TEST_TELUS_INVENTORY,
        TEST_INFINITY_INVENTORY: process.env.TEST_INFINITY_INVENTORY,
        TEST_PLOVDIV_INVENTORY: process.env.TEST_PLOVDIV_INVENTORY,
    },
    KEY,
